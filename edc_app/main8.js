...
if(lang!=null && lang.indexOf("ar")>-1)
{
    ...
    fields= [
            ...
            { name: "taskId", type: "text", title: "taskId", editing: false, visible: false, width: 90, autosearch: true },
    ...
    $("#jsGrid").jsGrid({
        ...
        controller: {
            loadData: function(filter) {
                ...
                var taskModel = new $.cordys.model({ objectName: "Task" });
                
                console.log("EDC Entry4");
                
                $.cordys.workflow.getTasks().done(
                            function(tasks) {
                                console.log(tasks);
